...
class GridWorld2(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        self.grid.vert_wall(1, 1, 10, self.wall_type)
        self.grid.vert_wall(3, 1, 8, self.wall_type)
        self.grid.vert_wall(10, 1, 10, self.wall_type)
        self.grid.vert_wall(8, 3, 6, self.wall_type)
        self.grid.vert_wall(5, 3, 4, self.wall_type)

        self.grid.horz_wall(4, 1, 6, self.wall_type)
        self.grid.horz_wall(2, 10, 8, self.wall_type)
        self.grid.horz_wall(4, 8, 4, self.wall_type)
        self.grid.horz_wall(6, 3, 2, self.wall_type)
        self.grid.horz_wall(6, 6, 1, self.wall_type)

        # self.grid.vert_wall(1, 2, 1, self.wall_type)
        # self.grid.vert_wall(1, 3, 1, self.wall_type)
    ...
    def step(self, action):
        ...
        if self.front_pos[0] < 0 or self.front_pos[0] >= self.width or \
                self.front_pos[1] < 0 or self.front_pos[1] >= self.height:
            fwd_cell = "outside"
        else:
