...
class Quantize(nn.Module):
    ...
    """
    def __init__(self, args, num_hiddens, n_embed, groups=1):
        super().__init__()
    ...
    def forward(self, z, reinit_codebook=False):
        ...
        if True and (reinit_codebook or (self.training and self.data_initialized.item() == 0)):
            print('running kmeans!!') if self.args.verbose else None
