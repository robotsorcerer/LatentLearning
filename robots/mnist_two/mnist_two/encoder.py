...
class Encoder(nn.Module):
    ...
    def __init__(self, args, ncodes, inp_size):
        ...
        for nf in [1,8,32]:
            self.qlst.append(Quantize(args, 512, ncodes, nf))
...
class Classifier(nn.Module):
    ...
    def __init__(self, args, ncodes, maxk, inp_size, verbose=False):
    ...
    def encode(self,x):
        if self.verbose:
            #print('verbose status: ', self.verbose)
