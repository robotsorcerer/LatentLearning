...
class fwSettings(object):
    ...
    # Physics options
    hz = 20.0
    # SEE: https://github.com/pybox2d/pybox2d/wiki/manual#simulating-the-world-of-box2d
    velocityIterations = 6 #8
    positionIterations = 2 #3
    enableWarmStarting = True
    enableContinuous = True
    enableSubStepping = False

    # Drawing
    drawStats = False  # put sim stats on screen 
    drawShapes = True
    drawJoints = True
