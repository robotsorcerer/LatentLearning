__comment__ = """ This file defines the base agent class. """
import abc
import copy

from .config import AGENT
from samples.sample_list import SampleList
ACTION='ACTION'
...
class Agent(object):
    ...
    def __init__(self, hyperparams):
        ...
        for sensor in self.obs_data_types:
            dim = self._hyperparams['obs_dims'][sensor]
            self._obs_idx.append(dim)
            # i += dim
        self.dO = dim
        ...
        for sensor in self.meta_data_types:
            dim = sensor #self._hyperparams['sensor_dims'][sensor]
