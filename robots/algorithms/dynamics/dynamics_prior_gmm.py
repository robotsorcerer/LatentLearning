__all__ = ["DynamicsPriorGMM"]
__comment__ = """ This file defines the GMM prior for dynamics estimation. """
...
from algorithms.dynamics.dynamics_utils import DYN_PRIOR_GMM
