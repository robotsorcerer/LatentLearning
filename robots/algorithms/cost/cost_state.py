__comment__ = """ This file defines the state target cost. """
import copy

import numpy as np

from algorithms.cost.config import COST_STATE
from algorithms.cost.cost import Cost
from algorithms.cost.cost_utils import evall1l2term, get_ramp_multiplier#evallogl2term_ant
