__comment__ = """ This file defines the forward kinematics cost function. """
import copy, os, csv

import numpy as np

from algorithms.cost.config import COST_FK
from algorithms.cost.cost import Cost
from algorithms.cost.cost_utils import get_ramp_multiplier
from algorithms.protocols import JOINT_ANGLES, END_EFFECTOR_POINTS, \
