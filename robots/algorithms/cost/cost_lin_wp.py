__comment__ = """ This file defines an arbitrary linear waypoint cost. """
import copy

import numpy as np

from algorithms.cost.config import COST_LIN_WP
from algorithms.cost.cost import Cost
from algorithms.cost.cost_utils import evall1l2term, get_ramp_multiplier
