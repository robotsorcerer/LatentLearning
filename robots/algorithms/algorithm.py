...
from algorithms.config import ALG
from algorithms.algorithm_utils import IterationData, TrajectoryInfo
from utility.robot_utils import extract_condition
...
class Algorithm(object):
    ...
    def _update_dynamics(self, integrate=True):
        """
        ...
        for m in range(self.M):
            ...
            X = cur_data.get_X(integrate=True)
            U = cur_data.get_U()
