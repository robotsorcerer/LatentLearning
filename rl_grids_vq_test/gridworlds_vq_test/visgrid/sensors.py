...
# class IsingSensor:
#     def __init__(self, N=18, beta=0.6, query_color=[255,255,255], ising_color=[255,255,255]):
#         self.ising = Ising(N=N, beta=beta)
#         self.query_color = query_color
#         self.ising_color = ising_color

#     def observe(self, s):
#         obs = (self.ising.step(n_steps=1)+1)/2
#         return s * obs