...
maze_name_list = ['maze_empty', 'maze_spiral']
name_index = 1
root = 'results/scores/{}/'.format(maze_name_list[name_index])
...
def plot(data, x, y, hue, style, col=None):
    ...
    palette = [red, blue, brown, purple, orange, yellow, pink, green]
    ...
    print("save here !!!")
    plt.grid()
    plt.savefig('results/figs/{}.png'.format(maze_name_list[name_index]))
    # plt.show()
